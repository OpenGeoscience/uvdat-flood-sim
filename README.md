...
3. Unitless Hydrograph: a list of proportions that sum to 1; these represent fractions of the total rainfall volume per timestep. The default list represents a near-constant rate over 24 hours.
